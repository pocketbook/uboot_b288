...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"setargs_common=setenv bootargs console=ttyS0,115200 earlyprintk=ttyS0,115200 partitions=${partitions} rootwait cma=48M\0" \
	"setargs_normal=setenv bootargs ${bootargs} root=/dev/mmcblk0p7 init=/init loglevel=0\0" \
	"setargs_recovery=setenv bootargs ${bootargs} root=/dev/ram0 init=/linuxrc loglevel=0 initrd=0x41000000,8M rootfstype=cramfs ramdisk_size=8192\0" \
	"load_images=fatload mmc 3:2 40007800 uImage;fatload mmc 3:2 42000000 default.wbf;read mmc 3:6 42200000 800 2000\0" \
	"boot_normal=run setargs_common setargs_normal load_images;bootm 40007800\0" \
	"boot_recovery=run setargs_common setargs_recovery load_images;fatload mmc 3:2 41000000 updatefs;bootm 40007800\0" \
...
#undef CONFIG_SUNXI_MODULE_DISPLAY
...
#define CONFIG_SUNXI_MODULE_TPS6515
#define  CONFIG_SUNXI_EINK_DISP
