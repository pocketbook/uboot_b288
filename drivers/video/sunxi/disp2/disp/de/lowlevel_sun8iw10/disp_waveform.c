...
//	memset(g_waveform_file.p_wf_vaddr, 0, 3<<20);
...
/*	printf("%s: mode=0x%x, temp=%d, mode_offset=0x%x, total=%d, data_addr=0x%x\n",\
		__func__,mode, temp, mode_temp_offset, *total_frames, *wf_buf);
*/
	return 0;
}
