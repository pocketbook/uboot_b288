...
#ifdef CONFIG_SUNXI_MODULE_TPS6515

int tps65185_init(void)
{
	return tps65185_probe();
}	
...
int disable_extflash_pins(void)
{
	printf("Disable PF0-PF5\n");
	uint32_t reg = 0x1c20800 + 5 * 0x24 + 0;
	writel(readl(reg) | 0x777777, reg);
	return 0;
}
